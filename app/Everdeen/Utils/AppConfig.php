...
class AppConfig
{
    ...
    const MAX_COOKIE_EXPIRED_TIME = 2147483647; //'2038-01-19 03:14:07'

    // custom
    const DAYS_BEFORE_CREATE_SESSION = 1;

    const CURRENCY_CODE_PHILIPPINES = 'PHP';
    const GOLDEN_HOURS_MAX_SALARY_RATE_PHILIPPINES = 190;

    const GOLDEN_HOURS_FROM = '12:00:00'; // 19h VNT
    const GOLDEN_HOURS_TO = '15:00:00'; // 22h VNT
}