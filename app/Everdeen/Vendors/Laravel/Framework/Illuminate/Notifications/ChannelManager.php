...
class ChannelManager extends BaseChannelManager
{
    ...
    protected function createIosDriver()
    {
        return $this->app->make(Channels\IosChannel::class);
    }

    protected function createAndroidDriver()
    {
        return $this->app->make(Channels\AndroidChannel::class);
    }
}