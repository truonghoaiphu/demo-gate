...
class StudentAddedReviewNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        $mailSubject = trans('label.new_review_from_student', [
        ...
        $baseMail = new BaseMailable('student_added_review_notification', [
