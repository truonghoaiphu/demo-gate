...
class TeacherInterviewReInvitationNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    {
        return new BaseMailable('teacher_interview_reinvitation', [
            ...
            BaseMailable::EMAIL_SUBJECT => trans('label.email_of_interview_schedule_reconfirm'),
