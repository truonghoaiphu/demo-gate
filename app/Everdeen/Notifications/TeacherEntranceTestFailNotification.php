...
class TeacherEntranceTestFailNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    {
        return new BaseMailable('teacher_entrance_test_fail', [
            ...
            BaseMailable::EMAIL_SUBJECT => ' ANTOREE | ' . ($this->teacherGroup ? ($this->teacherGroup['name'] . ' | ') : '') . ($this->user->nationality ? ($this->user->nationality->name . ' | ') : '') . trans('label.email_of_result_entrace_test'),
